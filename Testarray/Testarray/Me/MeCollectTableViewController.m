//
//  MeCollectTableViewController.m
//  Testarray
//
...
@interface MeCollectTableViewController ()
@property (nonatomic, strong) NSMutableArray *collectArray;
@end

@implementation MeCollectTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.collectArray = [[CHCollectModel findAll] mutableCopy];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    cell.house = self.collectArray[indexPath.row];
    return cell;
}
