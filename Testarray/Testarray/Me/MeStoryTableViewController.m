...
@interface MeStoryTableViewController () <TZImagePickerControllerDelegate,UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UIImageView *headerImage;

@end

@implementation MeStoryTableViewController
...
//    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cellme" forIndexPath:indexPath];
//    
//     
//    
//    return cell;
...
- (void)imagePickerController:(TZImagePickerController *)picker didFinishPickingPhotos:(NSArray<UIImage *> *)photos sourceAssets:(NSArray *)assets isSelectOriginalPhoto:(BOOL)isSelectOriginalPhoto;
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        //[self.headerImageView.im setImage:photos[0] forState:UIControlStateNormal];
